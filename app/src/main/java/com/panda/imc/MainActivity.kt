...
class MainActivity : AppCompatActivity() {
    ...
    private fun resultImc() {
        ...
        when (val oper = (weigth / high).toFloat()) {
            in 0.0..18.4 -> {
                resultView.text = "Alerta!!Desnutricion su IMC es:$oper"
            }
            in 18.5..24.9 -> {
                resultView.text = "Felicitaciones Normal su IMC es:$oper "
            }
            in 25.0..29.9 -> {
                resultView.text = "Alerta!! Obesidad su IMC es :$oper"
            }
            in 30.0..40.0 -> {
                resultView.text = "Consulte su EPS su IMC es :$oper"
            }
            else -> {
                resultView.text = noOp
            }
        }
    }
